...
public class AutonomyTwo extends Robot {
     ...
     * Each value is between approx. [67 ; 770 (very close - contact)]
    ...
    public void run() {
        ...
        while (step(timeStep) != -1 && this.stop != 1) {
            ...
            if (cible == null) {
                ...
                //front - left and left obstacle
                if ((IR[5] >= 125 && IR[6] >= 125) || (IR[6] >= 125 && IR[7] >= 125)) {
                    //turn right
                    this.move(25, -25);
                ...
                //front - right and right obstacle
                if ((IR[0] >= 125 && IR[1] >= 125) || (IR[1] >= 125 && IR[2] >= 125)) {
                    //turn left
                    this.move(-25, 25);
                    //wait
                    try {
